...
a2 :  BinOpExp(reg, ConstExp(const), plus)  :: :: 0
a2 :  BinOpExp(ConstExp(const), reg), plus) :: :: 0
a3 :  ConstExp(const) :: :: 0
a4 :  ConstExp(0) :: :: 0
...
reg : MemExp(a2)  	:: move new_reg, [a2.reg + const] :: 0.5
reg : MemExp(a3)   	:: move new_reg, [const] :: 0.5
...
stmt : MoveStmt(reg1, a2) 	:: move reg1, [a2.reg1 + a2.const] :: 0.5
stmt : MoveStmt(reg1, a3) 	:: move reg1, [a3.const] :: 0.5

stmt : MoveStmt(a1, reg2) 	:: move QWORD PTR [a1.reg1 + a1.reg2], reg2  :: 1
stmt : MoveStmt(a2, reg2) 	:: move QWORD PTR [a2.reg1 + a2.const], reg2 :: 1
