...
#define SHOULD_FAIL(filename, msgs)                                                                \
  ...
  TEST_CASE("invalid_book_examples")
  {
    ...
    CHECK(parser.had_error());
    CHECK(serr.str() ==
          "[../tests/book/test49.tig:5:21] Err at 'nil': expected 'in' after let decls\n");
  }

  SHOULD_FAIL("empty.tig",
              "[../tests/parser/invalid/empty.tig:1:1] Err at '$': expected expression\n");

  SHOULD_FAIL(
    "junk.tig",
    "[../tests/parser/invalid/junk.tig:7:1] Err at 'junk': unexpected token after expression\n");

  SHOULD_FAIL("seq.tig",
              "[../tests/parser/invalid/seq.tig:4:4] Err at '$': expected ')' closing a sequence "
              "expression\n");
  ...
  SHOULD_FAIL(
    ...
    "[../tests/parser/invalid/record.tig:12:1] Err at 'end': expected record field name after "
    "token '.'\n");

  SHOULD_FAIL(
    "array.tig",
    "[../tests/parser/invalid/array.tig:4:13] Err at '[': expected variable before token '['\n"
    "[../tests/parser/invalid/array.tig:5:15] Err at '[': expected type identifier before token "
    "'[' of "
    "array "
    "expression\n"
    "[../tests/parser/invalid/array.tig:7:6] Err at ';': expected ']' closing subscript "
    "expression\n"
  ...
  SHOULD_FAIL(
    ...
    "[../tests/parser/invalid/let.tig:7:2] Err at '$': expected ')' closing a sequence "
    "expression\n");
  ...
  SHOULD_FAIL(
    ...
    "[../tests/parser/invalid/if.tig:6:2] Err at '$': expected ')' closing a sequence "
    "expression\n");

  SHOULD_FAIL(
    "while.tig",
    "[../tests/parser/invalid/while.tig:1:8] Err at '$': expected 'do' after while condition\n");
  ...
  SHOULD_FAIL(
    ...
    "[../tests/parser/invalid/func.tig:4:3] Err at 'function': expected '(' in function "
    "declaration\n"
    ...
    "[../tests/parser/invalid/func.tig:8:3] Err at 'function': expected ')' in function "
    "declaration\n"
